...
const ACTION_LABELS: Record<string, AuditActionLabel> = {
  ...
  'lote.timer_paused': { label: 'Temporizador pausado', variant: 'warning' },
  'lote.timer_resumed': { label: 'Temporizador reanudado', variant: 'brand' },
  'lote.timer_reset': { label: 'Temporizador reiniciado', variant: 'neutral' },
  'lote.timer_adjusted': { label: 'Tiempo del lote ajustado', variant: 'neutral' },
  'lote.timer_auto_close_toggled': { label: 'Cierre automático modificado', variant: 'neutral' },
  ...
  'postauction.case_created': { label: 'Caso post-remate generado', variant: 'brand' },
  'postauction.status_changed': { label: 'Estado post-remate actualizado', variant: 'brand' },
  'postauction.note_added': { label: 'Observación post-remate agregada', variant: 'neutral' },
